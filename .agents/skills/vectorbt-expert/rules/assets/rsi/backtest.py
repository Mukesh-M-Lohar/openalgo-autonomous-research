...
print("  -> Worst peak-to-trough decline. RSI strategies tend to have lower drawdowns.")
print(f"* Win Rate: {pf.trades.win_rate() * 100:.1f}%")
print("  -> RSI strategies typically have higher win rates (50-65%) but smaller gains.")
print(
