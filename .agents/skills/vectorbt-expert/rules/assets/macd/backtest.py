...
print(
    f"* Total Return: Your strategy made {pf.total_return() * 100:.2f}% "
...
print("  -> This measures return per unit of risk. Think of it as 'bang for your buck'.")
print("     Below 1 = not enough return for the risk taken")
print("     1-2 = decent, 2+ = very good")
print(f"* Max Drawdown: {pf.max_drawdown() * 100:.2f}%")
print("  -> The biggest drop from peak. If you invested 10L, you would have temporarily")
