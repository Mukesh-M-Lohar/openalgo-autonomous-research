...
print("* The strategy rotates quarterly into whichever ETF performed better last quarter")
print("* This captures momentum - assets that did well recently tend to continue")
...
fig.update_layout(template="plotly_dark", title="Dual Momentum vs NIFTY 50", height=700)
fig.show()
