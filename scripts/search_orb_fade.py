...
def simulate_orb_fade(
    ...
    for day_df in days_list:
        ...
        )  # Fade downside breakout: buy OR low breach
        short_trigger = or_high * (
            1.0 + buffer_pct / 100.0
        )  # Fade upside breakout: sell OR high breach
