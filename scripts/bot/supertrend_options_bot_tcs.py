"""
Standalone Bot: Supertrend Options Touch Bot for Tata Consultancy Services (TCS) (TCS)
===================================================================
Rank 10 Stock: Tata Consultancy Services (TCS) (TCS)
Reason: Stable, liquid options

This production bot executes live/paper options trading based on Supertrend band touch signals:
- Subscribes to OpenAlgo WebSocket streaming feed for real-time underlying price monitoring (NSE:TCS).
...
logger = logging.getLogger("SupertrendOptionsBot_TCS")
...
PRODUCT = "MIS"
AVOID_0DTE = False
STRATEGY_NAME = "SupertrendOptionsBot_TCS"
...
class SupertrendStockOptionsBot:
    def __init__(self):
        logger.info(
            "Initializing Supertrend Options Bot for Tata Consultancy Services (TCS) (TCS)..."
        )
