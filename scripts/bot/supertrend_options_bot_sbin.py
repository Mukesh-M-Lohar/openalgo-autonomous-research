"""
Standalone Bot: Supertrend Options Touch Bot for State Bank of India (SBI) (SBIN)
===================================================================
Rank 4 Stock: State Bank of India (SBI) (SBIN)
...
- Subscribes to OpenAlgo WebSocket streaming feed for real-time underlying price monitoring (NSE:SBIN).
...
logger = logging.getLogger("SupertrendOptionsBot_SBIN")
...
PRODUCT = "MIS"
AVOID_0DTE = False
STRATEGY_NAME = "SupertrendOptionsBot_SBIN"
...
class SupertrendStockOptionsBot:
    def __init__(self):
        logger.info("Initializing Supertrend Options Bot for State Bank of India (SBI) (SBIN)...")
