"""
Standalone Bot: Supertrend Options Touch Bot for Tata Motors (TATAMOTORS)
===================================================================
Rank 5 Stock: Tata Motors (TATAMOTORS)
Reason: One of the best momentum stocks

This production bot executes live/paper options trading based on Supertrend band touch signals:
- Subscribes to OpenAlgo WebSocket streaming feed for real-time underlying price monitoring (NSE:TATAMOTORS).
...
logger = logging.getLogger("SupertrendOptionsBot_TATAMOTORS")
...
PRODUCT = "MIS"
AVOID_0DTE = False
STRATEGY_NAME = "SupertrendOptionsBot_TATAMOTORS"
...
class SupertrendStockOptionsBot:
    def __init__(self):
        logger.info("Initializing Supertrend Options Bot for Tata Motors (TATAMOTORS)...")
