"""
CDSL VWAP + RSI Pullback Intraday Strategy Bot for OpenAlgo
---------------------------------------------------------
...
class OpenAlgoStrategyBot:
    def __init__(self):
        ...
        self.strategy_name = os.getenv("STRATEGY_NAME", "CDSL_VWAP_RSI_Intraday")
