"""
Standalone Bot: Supertrend Options Touch Bot for Reliance Industries (RELIANCE)
===================================================================
Rank 1 Stock: Reliance Industries (RELIANCE)
Reason: Highest liquidity, strong trends

This production bot executes live/paper options trading based on Supertrend band touch signals:
- Subscribes to OpenAlgo WebSocket streaming feed for real-time underlying price monitoring (NSE:RELIANCE).
...
logger = logging.getLogger("SupertrendOptionsBot_RELIANCE")
...
PRODUCT = "MIS"
AVOID_0DTE = False
STRATEGY_NAME = "SupertrendOptionsBot_RELIANCE"
...
class SupertrendStockOptionsBot:
    def __init__(self):
        logger.info("Initializing Supertrend Options Bot for Reliance Industries (RELIANCE)...")
