"""
Standalone Bot: Supertrend Options Touch Bot for Bharti Airtel (BHARTIARTL)
===================================================================
Rank 8 Stock: Bharti Airtel (BHARTIARTL)
Reason: Good liquidity and trend continuation

This production bot executes live/paper options trading based on Supertrend band touch signals:
- Subscribes to OpenAlgo WebSocket streaming feed for real-time underlying price monitoring (NSE:BHARTIARTL).
...
logger = logging.getLogger("SupertrendOptionsBot_BHARTIARTL")
...
ST_PERIOD = 10
ST_MULT = 3.0
DEFAULT_STRIKE_STEP = 10
STRIKE_STEPS_ITM = 1  # 1 step ITM
LOTS = 1  # Number of option lots
PRODUCT = "MIS"
AVOID_0DTE = False
STRATEGY_NAME = "SupertrendOptionsBot_BHARTIARTL"
...
class SupertrendStockOptionsBot:
    def __init__(self):
        logger.info("Initializing Supertrend Options Bot for Bharti Airtel (BHARTIARTL)...")
