"""
Standalone Bot: Supertrend Options Touch Bot for HDFC Bank (HDFCBANK)
===================================================================
Rank 3 Stock: HDFC Bank (HDFCBANK)
Reason: Clean price action, tight spreads

This production bot executes live/paper options trading based on Supertrend band touch signals:
- Subscribes to OpenAlgo WebSocket streaming feed for real-time underlying price monitoring (NSE:HDFCBANK).
...
logger = logging.getLogger("SupertrendOptionsBot_HDFCBANK")
...
PRODUCT = "MIS"
AVOID_0DTE = False
STRATEGY_NAME = "SupertrendOptionsBot_HDFCBANK"
...
class SupertrendStockOptionsBot:
    def __init__(self):
        logger.info("Initializing Supertrend Options Bot for HDFC Bank (HDFCBANK)...")
