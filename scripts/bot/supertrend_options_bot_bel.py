"""
Standalone Bot: Supertrend Options Touch Bot for Bharat Electronics (BEL) (BEL)
===================================================================
Rank 13 Stock: Bharat Electronics (BEL) (BEL)
Reason: Strong momentum during defense themes

This production bot executes live/paper options trading based on Supertrend band touch signals:
- Subscribes to OpenAlgo WebSocket streaming feed for real-time underlying price monitoring (NSE:BEL).
...
logger = logging.getLogger("SupertrendOptionsBot_BEL")
...
ST_PERIOD = 10
ST_MULT = 3.0
DEFAULT_STRIKE_STEP = 5
STRIKE_STEPS_ITM = 1  # 1 step ITM
LOTS = 1  # Number of option lots
PRODUCT = "MIS"
AVOID_0DTE = False
STRATEGY_NAME = "SupertrendOptionsBot_BEL"
...
class SupertrendStockOptionsBot:
    def __init__(self):
        logger.info("Initializing Supertrend Options Bot for Bharat Electronics (BEL) (BEL)...")
