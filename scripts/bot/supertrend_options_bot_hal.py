"""
Standalone Bot: Supertrend Options Touch Bot for Hindustan Aeronautics (HAL) (HAL)
===================================================================
Rank 14 Stock: Hindustan Aeronautics (HAL) (HAL)
Reason: High-beta defense stock

This production bot executes live/paper options trading based on Supertrend band touch signals:
- Subscribes to OpenAlgo WebSocket streaming feed for real-time underlying price monitoring (NSE:HAL).
...
logger = logging.getLogger("SupertrendOptionsBot_HAL")
...
PRODUCT = "MIS"
AVOID_0DTE = False
STRATEGY_NAME = "SupertrendOptionsBot_HAL"
...
class SupertrendStockOptionsBot:
    def __init__(self):
        logger.info("Initializing Supertrend Options Bot for Hindustan Aeronautics (HAL) (HAL)...")
