"""
Standalone Bot: Supertrend Options Touch Bot for Larsen & Toubro (L&T) (LT)
===================================================================
Rank 7 Stock: Larsen & Toubro (L&T) (LT)
Reason: Reliable directional trends

This production bot executes live/paper options trading based on Supertrend band touch signals:
- Subscribes to OpenAlgo WebSocket streaming feed for real-time underlying price monitoring (NSE:LT).
...
logger = logging.getLogger("SupertrendOptionsBot_LT")
...
PRODUCT = "MIS"
AVOID_0DTE = False
STRATEGY_NAME = "SupertrendOptionsBot_LT"
...
class SupertrendStockOptionsBot:
    def __init__(self):
        logger.info("Initializing Supertrend Options Bot for Larsen & Toubro (L&T) (LT)...")
