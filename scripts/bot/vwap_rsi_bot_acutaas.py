"""
ACUTAAS VWAP + RSI Pullback Intraday Strategy Bot for OpenAlgo
---------------------------------------------------------
...
# Trade Parameters
SYMBOL = os.getenv("SYMBOL", "ACUTAAS")
...
class OpenAlgoStrategyBot:
    def __init__(self):
        ...
        self.strategy_name = os.getenv("STRATEGY_NAME", "ACUTAAS_VWAP_RSI_Intraday")
