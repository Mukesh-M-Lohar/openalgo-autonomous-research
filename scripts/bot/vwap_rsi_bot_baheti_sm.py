"""
BAHETI-SM VWAP + RSI Pullback Intraday Strategy Bot for OpenAlgo
---------------------------------------------------------
...
# Trade Parameters
SYMBOL = os.getenv("SYMBOL", "BAHETI-SM")
...
class OpenAlgoStrategyBot:
    def __init__(self):
        ...
        self.strategy_name = os.getenv("STRATEGY_NAME", "BAHETI-SM_VWAP_RSI_Intraday")
