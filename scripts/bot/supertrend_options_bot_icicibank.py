"""
Standalone Bot: Supertrend Options Touch Bot for ICICI Bank (ICICIBANK)
===================================================================
Rank 2 Stock: ICICI Bank (ICICIBANK)
Reason: Excellent banking momentum

This production bot executes live/paper options trading based on Supertrend band touch signals:
- Subscribes to OpenAlgo WebSocket streaming feed for real-time underlying price monitoring (NSE:ICICIBANK).
...
logger = logging.getLogger("SupertrendOptionsBot_ICICIBANK")
...
PRODUCT = "MIS"
AVOID_0DTE = False
STRATEGY_NAME = "SupertrendOptionsBot_ICICIBANK"
...
class SupertrendStockOptionsBot:
    def __init__(self):
        logger.info("Initializing Supertrend Options Bot for ICICI Bank (ICICIBANK)...")
