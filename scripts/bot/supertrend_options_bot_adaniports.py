"""
Standalone Bot: Supertrend Options Touch Bot for Adani Ports (ADANIPORTS)
===================================================================
Rank 12 Stock: Adani Ports (ADANIPORTS)
Reason: Good liquidity and volatility

This production bot executes live/paper options trading based on Supertrend band touch signals:
- Subscribes to OpenAlgo WebSocket streaming feed for real-time underlying price monitoring (NSE:ADANIPORTS).
...
logger = logging.getLogger("SupertrendOptionsBot_ADANIPORTS")
...
PRODUCT = "MIS"
AVOID_0DTE = False
STRATEGY_NAME = "SupertrendOptionsBot_ADANIPORTS"
...
class SupertrendStockOptionsBot:
    def __init__(self):
        logger.info("Initializing Supertrend Options Bot for Adani Ports (ADANIPORTS)...")
